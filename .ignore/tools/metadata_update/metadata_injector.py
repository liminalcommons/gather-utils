...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Inject metadata into tool files"
    )
    ...
    parser.add_argument(
        "--author", default="Development Team", help="Author of the tool"
    )
    parser.add_argument(
        "--purpose", required=True, help="Clear description of tool's purpose"
    )
    parser.add_argument(
        "--dependencies", default="None", help="Required packages/tools"
    )
    parser.add_argument(
        "--created-reason", required=True, help="Why the tool was created"
    )
    parser.add_argument(
        "--active-status", required=True, help="Current usage status"
    )
    parser.add_argument(
        "--obsolescence",
        nargs="+",
        required=True,
        help="Conditions for obsolescence",
    )
