    ...
    return {
        ...
        "objects": [
            ...
            # Case 3: Object with portal-related properties
            {
                ...
                "x": 30,
                "y": 40,
                "properties": {"isPortal": True, "target": "map4"},
            },
            # Case 4: Integer type that matches potential portal types
            {"id": "portal4", "type": 6, "x": 50, "y": 60},
            # Regular object (not a portal)
            {"id": "obj1", "type": "image", "x": 70, "y": 80},
        ],
    }
...
class TestPortalDetection:
    ...
    def test_detect_string_portal_type(self, client, complex_map_data):
        ...
        assert (
            portal1 is not None
        ), "Portal with string 'portal' type should be detected"
    ...
    def test_detect_integer_type_with_targetmap(
        ...
        assert (
            portal2 is not None
        ), "Portal with integer type and targetMap should be detected"
    ...
    def test_detect_portal_properties(self, client, complex_map_data):
        ...
        assert (
            portal3 is not None
        ), "Portal with portal-related properties should be detected"
    ...
    def test_detect_specific_integer_types(self, client, complex_map_data):
        ...
        assert (
            portal4 is not None
        ), "Portal with specific integer type should be detected"
